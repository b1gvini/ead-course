...
public class ModuleController {
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModulesIntoCourse(@PathVariable(value = "courseId") UUID courseId, SpecificationTemplate.ModuleSpec spec,
    ...
    public ResponseEntity<Object> getOneModule(@PathVariable(value = "courseId")UUID courseId,
        ...
        return moduleModelOptional.
                ...
                moduleModel -> ResponseEntity.status(HttpStatus.OK).body(moduleModel))
                .orElseGet(
